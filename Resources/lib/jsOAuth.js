...
exports.OAuth = function(a) {
	...
	function d(a) {
		var b = arguments, c = b.callee, d, f, g, h, i, j, k, l = /^([^:\/?#]+?:\/\/)*([^\/:?#]*)?(:[^\/?#]*)*([^?#]*)(\?[^#]*)?(#(.*))*/, m = this;
		if (!(this instanceof c))
			return new c(a);
	...
	function t(a, b, c, d) {
		var e = n(b), f = n(c), g = e.length, h, i, j, k;
	...
	c.prototype = {
		...
		if (c == 1) {
			if ( typeof a == "object")
				for (d in a)a.hasOwnProperty(d) && (g[d] = a[d]);
	...
	return g.prototype = {
		...
		init : function(a) {
			...
			return this.realm = a.realm || b, this.requestTokenUrl = a.requestTokenUrl || b, this.authorizationUrl = a.authorizationUrl || b, this.accessTokenUrl = a.accessTokenUrl || b, this.getAccessToken = function() {
				...
				var b, e, m, n, o, p, q, r, s, t, u, v, w = [], x, y = {}, z, A;
				...
				function() {
					...
					if (q.readyState === 4) {
						...
						Ti.API.info('This is response text' + q.responseText);
						var i = q.responseText;/*{
							text : q.responseText,
							xml : h ? q.responseXML : "",
							requestHeaders : b,
							responseHeaders : c
				...
				if ((!("Content-Type" in n) || n["Content-Type"] == "application/x-www-form-urlencoded") && !A)
					for (r in m)
					y[r] = m[r];
				urlString = e.scheme + "://" + e.host + e.path, u = i(b, urlString, s, y), v = g.signatureMethod[t](c.consumerSecret, c.accessTokenSecret, u), s.oauth_signature = v, this.realm && (s.realm = this.realm), c.proxyUrl && ( e = d(c.proxyUrl + e.path));
				if (x || b == "GET")
		...
		parseTokenRequest : function(a, b) {
			switch(b) {
				case"text/xml":
					...
					break;
				default:
					var e = 0, f = a.text.split("&"), h = f.length, i = {};
					for (; e < h; ++e) {
						var j = f[e].split("=");
		...
		var b = [1732584193, 4023233417, 2562383102, 271733878, 3285377520], c = [1518500249, 1859775393, 2400959708, 3395469782], d, e, f, g, h, i, j, k, l, p, q, s, t, u, v, w, x, y, z;
